...
const projects = [
  ...
  },
  {
    ...
    image: "/assets1/work/movieapp.png",
    live: "https://movies-app-alexislerch.vercel.app/",
          ...
          <div className="w-full xl:w-[50%]">
            ...
            >
              ...
              <WorkSliderBtns
                ...
                btnStyles="bg-black rounded-[10px] hover:bg-white text-white hover:text-black text-[22px] w-[44px] h-[44px] flex justify-center items-center transition-all"
              />
            </Swiper>
          </div>
        </div>
